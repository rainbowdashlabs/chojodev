...
The minecraft main class or the class which usually extend `JavaPlugin` is nearly always suspect of discussions when 
it comes to naming. 
In this post I try to explain my point of view and also show my approach into naming.
